...
public class RenderItemFrameEx extends Render
{
	private static final ResourceLocation mapBackgroundTextures = new ResourceLocation("textures/map/map_background.png");
	private static final ResourceLocation resource     = new ResourceLocation("textures/blocks/itemframe_background.png");
	...
	private RenderItemFrame frame;

	private IIconRegister reg;

	public RenderItemFrameEx() 
	{
//		frame = new RenderItemFrame();
//		frame.updateIcons(Minecraft.getMinecraft().getTextureMapBlocks());
//		reg = par1IconRegister;
		//this.updateIcons(par1IconRegister);
	}
	
	private static final ResourceLocation tex = new ResourceLocation("itemframe_background");
	...
	public void doRender(EntityItemFrame par1EntityItemFrame, double par2, double par4, double par6, float par8, float par9)
	{
		...
		if ((!SkipsignCore.ModSetting.HideBoard.Bool()) || (SkipsignCore.ModSetting.HideBoard.Bool() && CheckVisibleState(par1EntityItemFrame)))
		{
		...
		if (CheckVisibleState(par1EntityItemFrame))
		{
	...
	public boolean CheckVisibleState(EntityItemFrame entityItemFrame)
	{
		...
		double x = entityItemFrame.posX, y = entityItemFrame.posY, z = entityItemFrame.posZ;
		...
		case 1:
			...
			double dist = p.getDistance(x, y, z);

			if (dist < SkipsignCore.ModSetting.FrameRange.Int() + 1 && dist > (-SkipsignCore.ModSetting.FrameRange.Int()))
			{
				return true;
			}
		}
	...
	{
		return this.getEntityTexture((EntityItemFrame)par1EntityItemFrame);
	}
